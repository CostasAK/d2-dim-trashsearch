...
const or_list = {
  ...
  armor:
    '-crystocrene -dreambane -is:classitem -is:exotic ((is:legendary power:<=powerfulcap) or (is:rare power:<1310)) basestat:total:<60 basestat:custom:<40',
  class_items: 'is:classitem (sunsetsin:<=next or power:<powerfulcap)'
}
